...
- Amount distribution: Lognormal(μ=2.84, σ=1.00)
...
class CalibratedMoMoDataGenerator:
    ...
    def __init__(self, 
        ...
        print(f"  - Amount: μ={self.calibration['amount_lognormal_mu']:.2f}, σ={self.calibration['amount_lognormal_sigma']:.2f}")
        print(f"  - Frequency: {self.calibration['transaction_frequency_hours']:.2f} hours between transactions")
        print(f"  - Balance: μ={self.calibration['balance_mean']:.2f}, σ={self.calibration['balance_std']:.2f}")
